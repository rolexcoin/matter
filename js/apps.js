...
const sttaddr = "0x7d0deacddf11dce0fb3a6c3f73f55cb05507dc8c";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x7d0deacddf11dce0fb3a6c3f73f55cb05507dc8c";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://rolexcoin.net?ref=' + document.getElementById('refaddress').value;
        }
    }
}
